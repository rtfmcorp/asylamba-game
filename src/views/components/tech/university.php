		...
		echo '<div class="body">';
			echo '<div class="number-box" id="uni-total-invest" data-invest="' . $player_university->iUniversity . '" data-baseid="' . $player_university->getId() . '">';
				...
				echo '<span class="value">';
					...
					echo ' <img alt="crédit" src="' . $mediaPath . 'resources/credit.png" class="icon-color">';
				echo '</span>';
				echo '<span class="group-link"><a title="modifier" class="hb lt" href="' . $appRoot . 'financial/">→</a></span>';
			echo '</div>';
	...
	echo '<div class="fix-body">';
		echo '<div class="body">';
			...
			echo '<div class="build-item">';
				echo '<div class="name">';
					echo '<img src="' . $mediaPath . 'university/mathematics.png" alt="" />';
			...
			echo '<div class="build-item">';
				echo '<div class="name">';
					echo '<img src="' . $mediaPath . 'university/chemistry.png" alt="" />';
			...
			echo '<div class="build-item">';
				echo '<div class="name">';
					echo '<img src="' . $mediaPath . 'university/physics.png" alt="" />';
			...
			echo '<div class="build-item">';
				echo '<div class="name">';
					echo '<img src="' . $mediaPath . 'university/law.png" alt="" />';
			...
			echo '<div class="build-item">';
				echo '<div class="name">';
					echo '<img src="' . $mediaPath . 'university/communication.png" alt="" />';
...
echo '<div class="component uni">';
	...
	echo '<div class="fix-body">';
		echo '<div class="body">';
			...
			echo '<div class="build-item">';
				echo '<div class="name">';
					echo '<img src="' . $mediaPath . 'university/networks.png" alt="" />';
			...
			echo '<div class="build-item">';
				echo '<div class="name">';
					echo '<img src="' . $mediaPath . 'university/algorithmic.png" alt="" />';
			...
			echo '<div class="build-item">';
				echo '<div class="name">';
					echo '<img src="' . $mediaPath . 'university/statistics.png" alt="" />';
			...
			echo '<div class="build-item">';
				echo '<div class="name">';
					echo '<img src="' . $mediaPath . 'university/economy.png" alt="" />';
			...
			echo '<div class="build-item">';
				echo '<div class="name">';
					echo '<img src="' . $mediaPath . 'university/psychology.png" alt="" />';
