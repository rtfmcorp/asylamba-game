		...
		echo '<div class="body">';
			for ($i = 0; $i < ASM::$prm->size(); $i++) {
				...
				if ($i == 0 && $p->resourcesPosition != 1) {
					echo '<a class="more-item" href="' . APP_ROOT . 'ajax/a-morerank/dir-next/type-defeat/current-' . $p->resourcesPosition . '" data-dir="top">';
				...
				if ($i == ASM::$prm->size() - 1) {
					echo '<a class="more-item" href="' . APP_ROOT . 'ajax/a-morerank/dir-prev/type-defeat/current-' . $p->resourcesPosition . '">';
