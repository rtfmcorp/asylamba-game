...
echo '<div class="component nav">';
	...
	echo '<div class="fix-body">';
		echo '<div class="body">';
			...
			echo '<a href="' . APP_ROOT . 'bases/view-main" class="nav-element ' . $active . '">';
			...
			if ($ob_obNav->getLevelGenerator() > 0) {
				...
				echo '<a href="' . APP_ROOT . 'bases/view-generator" class="nav-element ' . $active . '">';
			...
			if ($ob_obNav->getLevelRefinery() > 0) {
				...
				echo '<a href="' . APP_ROOT . 'bases/view-refinery" class="nav-element ' . $active . '">';
			...
			if ($ob_obNav->getLevelTechnosphere() > 0) {
				...
				echo '<a href="' . APP_ROOT . 'bases/view-technosphere" class="nav-element ' . $active . '">';
			...
			if ($ob_obNav->getLevelDock1() > 0) {
				...
				echo '<a href="' . APP_ROOT . 'bases/view-dock1" class="nav-element ' . $active . '">';
			...
			if ($ob_obNav->getLevelDock2() > 0) {
				...
				echo '<a href="' . APP_ROOT . 'bases/view-dock2" class="nav-element ' . $active . '">';
			...
			if ($ob_obNav->getLevelCommercialPlateforme() > 0) {
				...
				echo '<a href="' . APP_ROOT . 'bases/view-commercialplateforme" class="nav-element ' . $active . '">';
			...
			echo '<a href="' . APP_ROOT . 'bases/view-university" class="nav-element ' . $active . '">';
			...
			echo '<a href="' . APP_ROOT . 'bases/view-school" class="nav-element ' . $active . '">';
			...
			echo '<a href="' . APP_ROOT . 'bases/view-antispy" class="nav-element ' . $active . '">';
