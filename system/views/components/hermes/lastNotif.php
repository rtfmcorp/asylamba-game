	...
	echo '<div class="fix-body">';
		echo '<div class="body">';
			...
			echo '<p class="info" id="info-notif" style="display:none;">';
				...
				Elles vous permettent d’avoir un compte rendu de toutes vos activités sur Expansion.<br/>Au bout d\'un certain temps, elles seront automatiquement supprimées, sauf si vous les archivez.';
			echo '</p>'; 
