		...
		echo '<div class="body">';
			...
			echo '<div class="number-box">';
				...
				echo '<span class="group-link">';
					echo '<a href="' . APP_ROOT . 'action/a-switchbase/base-' . $ob_obFastView->getId() . '/page-refinery" class="link hb lt" title="vers la raffinerie">→</a>';
				echo '</span>';
			echo '</div>';
			...
			echo '<div class="number-box ' . ((ASM::$bqm->size() == 0) ? 'grey' : '') . '">';
				...
				echo '<span class="group-link">';
					echo '<a href="' . APP_ROOT . 'action/a-switchbase/base-' . $ob_obFastView->getId() . '/page-generator" class="link hb lt" title="vers le générateur">→</a>';
				echo '</span>';
			echo '</div>';
			...
			echo '<div class="number-box ' . ((($dock1 + $dock2) == 0) ? 'grey' : '') . '">';
				...
				echo '<span class="group-link">';
					echo '<a href="' . APP_ROOT . 'action/a-switchbase/base-' . $ob_obFastView->getId() . '/page-dock1" class="link hb lt" title="vers le chantier alpha">→</a>';
				echo '</span>';
			echo '</div>';
			...
			echo '<div class="number-box ' . ((ASM::$tqm->size() == 0) ? 'grey' : '') . '">';
				...
				echo '<span class="group-link">';
					echo '<a href="' . APP_ROOT . 'action/a-switchbase/base-' . $ob_obFastView->getId() . '/page-technosphere" class="link hb lt" title="vers la technosphère">→</a>';
				echo '</span>';
			echo '</div>';
