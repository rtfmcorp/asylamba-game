	...
	echo '<div class="overflow">';
		...
		echo '<a href="' . APP_ROOT . 'bases/view-main" class="item ' . $active . '">';
			...
			echo '<span class="content">';
				echo '<span class="label">Vue de situation</span>';
				echo '<span class="value">Affiche un aperçu rapide de votre base</span>';
			echo '</span>';
		echo '</a>';
		...
		if ($base->getLevelGenerator() > 0) {
			...
			echo '<a href="' . APP_ROOT . 'bases/view-generator" class="item ' . $active . '">';
				...
				echo '</span>';
				echo '<span class="content">';
					echo '<span class="label">' . OrbitalBaseResource::getBuildingInfo(0, 'frenchName') . '</span>';
					echo '<span class="value">Desc</span>';
				echo '</span>';
			echo '</a>';
		}
		...
		if ($base->getLevelRefinery() > 0) {
			...
			echo '<a href="' . APP_ROOT . 'bases/view-refinery" class="item ' . $active . '">';
				...
				echo '</span>';
				echo '<span class="content">';
					echo '<span class="label">' . OrbitalBaseResource::getBuildingInfo(1, 'frenchName') . '</span>';
					echo '<span class="value">Desc</span>';
				echo '</span>';
			echo '</a>';
		}
		...
		if ($base->getLevelTechnosphere() > 0) {
			...
			echo '<a href="' . APP_ROOT . 'bases/view-technosphere" class="item ' . $active . '">';
				...
				echo '</span>';
				echo '<span class="content">';
					echo '<span class="label">' . OrbitalBaseResource::getBuildingInfo(5, 'frenchName') . '</span>';
					echo '<span class="value">Desc</span>';
				echo '</span>';
			echo '</a>';
		}
		...
		if ($base->getLevelDock1() > 0) {
			...
			echo '<a href="' . APP_ROOT . 'bases/view-dock1" class="item ' . $active . '">';
				...
				echo '</span>';
				echo '<span class="content">';
					echo '<span class="label">' . OrbitalBaseResource::getBuildingInfo(2, 'frenchName') . '</span>';
					echo '<span class="value">Desc</span>';
				echo '</span>';
			echo '</a>';
		}
		...
		if ($base->getLevelDock2() > 0) {
			...
			echo '<a href="' . APP_ROOT . 'bases/view-dock2" class="item ' . $active . '">';
				...
				echo '</span>';
				echo '<span class="content">';
					echo '<span class="label">' . OrbitalBaseResource::getBuildingInfo(3, 'frenchName') . '</span>';
					echo '<span class="value">Desc</span>';
				echo '</span>';
			echo '</a>';
		}
		...
		if ($base->getLevelCommercialPlateforme() > 0) {
			...
			echo '<a href="' . APP_ROOT . 'bases/view-commercialplateforme" class="item ' . $active . '">';
				...
				echo '</span>';
				echo '<span class="content">';
					echo '<span class="label">' . OrbitalBaseResource::getBuildingInfo(6, 'frenchName') . '</span>';
					echo '<span class="value">Desc</span>';
				echo '</span>';
			echo '</a>';
		}
		...
		echo '<a href="' . APP_ROOT . 'bases/view-school" class="item ' . $active . '">';
			...
			echo '</span>';
			echo '<span class="content">';
				echo '<span class="label">Ecole de Commandement</span>';
				echo '<span class="value">formation des officiers</span>';
			echo '</span>';
		echo '</a>';
		...
		echo '<a href="' . APP_ROOT . 'bases/view-antispy" class="item ' . $active . '">';
			...
			echo '</span>';
			echo '<span class="content">';
				echo '<span class="label">Renseignement</span>';
				echo '<span class="value">radar</span>';
			echo '</span>';
		echo '</a>';
	echo '</div>';
echo '</div>';
