...
class ColorResource {
	...
	private static $colors = array(
		...
		array(
			...
			'status' => array('Guerrier', 'Dynaste','Dynastaire-trésorier', 'Dynastaire-chef de guerre', 'Dynastaire-ministre', 'Hérault'),
		...
		array(
			...
			'status' => array('Commerçant', 'Négociant', 'Gestionnaire-trésorier', 'Gestionnaire-chef de guerre', 'Gestionnaire-ministre', 'Vizir'),
