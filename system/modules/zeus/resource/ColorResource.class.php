...
class ColorResource {
	...
	private static $colors = array(
		array(
			...
			'status' 		=> array('Noble', 'Dynaste', 'Trésorier', 'Dynastaire-chef de guerre', 'Intendant', 'Empereur'),
		...
		array(
			...
			'status' 		=> array('Commerçant', 'Négociant', 'Financier', 'Armateur', 'Ministre', 'Viziduc'),
		...
		array(
			...
			'status' 		=> array('Fidèle', 'Prêtre', 'Questeur', 'Inquisiteur', 'Archiprêtre', 'Guide'),
		...
		array(
			...
			'status' 		=> array('Citoyen', 'Député', 'Conseiller aux finances', 'Stratège', 'Conseiller', 'Chancelier'),
