...
class ColorResource {
	...
	private static $colors = array(
		array(
			...
			'status' 		=> array('Noble', 'Dynaste', 'Trésorier', 'Chef de guerre', 'Intendant', 'Empereur'),
		...
		array(
			...
			'status' 		=> array('Guerrier', 'Dynaste', 'Trésorier', 'Conquérant', 'Ministre', 'Baron'),
		...
		array(
			...
			'status' 		=> array('Citoyen', 'Député', 'Conseiller aux finances', 'Conseiller de Guerre', 'Premier Conseiller', 'Chancelier'),
		...
		array(
			...
			'status' 		=> array('Fédéré', 'Conseiller', 'Consul des Finances', 'Consul de Guerre', 'Premier Consul', 'Fédérant'),
